...
`LICENSE` that applies to the Tank Monitor Console Multitool itself, which is copyright
(c) 2026 Verbose Software. Their licences continue to govern them. Full licence texts are
